...
public class ApplicationHostProxy {
    ...
    private void loadApplication() throws Throwable {
        ...
        final DexClassLoader pluginClassLoader = mPluginInfo.getPluginClassLoader();
        if (pluginClassLoader == null) {
            throw new Exception("plugin class loader is null");
        }


        Class<?> targetCls = mPluginInfo.getPluginClassLoader().loadClass(mPluginApplicationClassName);
        try {
